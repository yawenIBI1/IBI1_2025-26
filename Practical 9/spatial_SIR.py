...
# 调整间距，彻底解决堆叠
plt.subplots_adjust(left=0.05, right=0.85, top=0.92, bottom=0.05, wspace=0.2, hspace=0.2)

# Add color bar to explain state encoding
cbar = fig.colorbar(im, ax=axes, shrink=0.7, pad=0.08)
cbar.set_ticks([0, 1, 2])
cbar.set_ticklabels(["Susceptible (0)", "Infected (1)", "Recovered (2)"])
...
print("="*60)
print("States: 0=Susceptible, 1=Infected, 2=Recovered")
print("="*60)