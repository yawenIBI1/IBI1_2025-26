def calculate_protein_mass(amino_acid_seq):
    ...
    # Return mass rounded to 2 decimal places to match table precision
    return round(total_mass, 2)

# input aa sequences
sequence = input("Please enter the amino acid sequence: ")
protein_mass = calculate_protein_mass(sequence)

print(f"\nInput sequence: {sequence}")
print(f"Total protein mass: {protein_mass} amu")